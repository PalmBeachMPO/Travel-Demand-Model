...
flowmap <- flowmapblue(
 ...
 clustering = TRUE,
 darkMode = TRUE,      # Keep the map dark
 animation = FALSE
)

# This style block ensures the main website text stays black and the background stays white
cat("
<style>
  body, p, h1, h2, h3, h4, li, span, a { 
...
# Your locked structural map container
htmltools::tags$div(
