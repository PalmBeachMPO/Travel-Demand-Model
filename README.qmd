...
[![Interactive Flowmap Demo](man/figures/demo.png)](https://palmbeachmpo.github.io/Travel-Demand-Model/)
...
ch_locations <- read.csv("C:/MPO/OneDrive - Palm Beach MPO/Documents/GitHub/Travel-Demand-Model/data-raw/locations.csv")
ch_flows <- read.csv("C:/MPO/OneDrive - Palm Beach MPO/Documents/GitHub/Travel-Demand-Model/data-raw/flows.csv")
...
# This wrapper creates a hard structural boundary that JavaScript cannot break out of
htmltools::tags$div(
  style = "position: relative; clear: both; width: 100%; min-height: 520px; margin-top: 30px; display: block;",
  htmltools::tags$div(
